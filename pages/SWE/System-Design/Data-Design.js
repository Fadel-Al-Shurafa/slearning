                                ...
                                <div className="container">
                                    ...
                                    <div className="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 ">
                                        ...
                                        <div className="col-6" >
                                            <div className="p-3 border bg-light" style={{ width: '12rem', height: '7rem' }}>
                                                <div className="justify-content-sm-center">
                                                <Link href='/SWE/System-Design'><h3 className="text-center">UI / UX design</h3></Link>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6" >
                                            <div className="p-3 border bg-light" style={{ width: '12rem', height: '7rem' }}>
                                                <div className="justify-content-sm-center">
                                                <Link href='/SWE/System-Design'><h3 className="text-center">Component design</h3></Link>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6" >
                                            <div className="p-3 border bg-light" style={{ width: '12rem', height: '7rem' }}>
                                                <div className="justify-content-sm-center">
                                                <Link href='/SWE/System-Design'><h3 className="text-center">Data design</h3></Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
